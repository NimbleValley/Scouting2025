...
function runSampleDifferenceOfMeans() {
    ...
    for (let i = 0; i < RECORDS.length; i++) {
        let index = teams.indexOf(parseInt(RECORDS[i].teamNumber));
        if (index != -1) {
...
function runTrial(r1, r2, r3) {
    ...
    let teleCoralBot1 = Math.round(parseInt(r1.teleCoral) * 1.15);
    let teleCoralBot2 = Math.round(parseInt(r2.teleCoral) * 1.15);
    let teleCoralBot3 = Math.round(parseInt(r3.teleCoral) * 1.15);
    ...
    autoL4Coral += parseInt(r1.autoL4Count) + parseInt(r2.autoL4Count) + parseInt(r3.autoL4Count);
    autoL2Coral += parseInt(r1.autoL2Count) + parseInt(r2.autoL2Count) + parseInt(r3.autoL2Count);

    totalL4Coral += autoL4Coral;
    totalL2Coral += autoL2Coral;

    if (parseInt(r1.teleL4Count) > 0 && totalL4Coral < 12) {
    ...
    if (parseInt(r2.teleL4Count) > 0 && totalL4Coral < 12) {
    ...
    if (parseInt(r3.teleL4Count) > 0 && totalL4Coral < 12) {
    ...
    let totalProcessor = parseInt(r1.teleProcessorCount) * 0.65 + parseInt(r2.teleProcessorCount) * 0.65 + parseInt(r3.teleProcessorCount) * 0.65;
    let totalNet = parseInt(r1.teleNetCount) * 1.25 + parseInt(r2.teleNetCount) * 1.25 + parseInt(r3.teleNetCount) * 1.25;
    let totalEndgame = parseInt(r1.endgamePoints) + parseInt(r2.endgamePoints) + parseInt(r3.endgamePoints);
